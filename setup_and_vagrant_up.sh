...
# Rename the default Vagrantfile to "Vagrantfile_old" if it exists
if [ -f "Vagrantfile" ]; then
  mv Vagrantfile Vagrantfile_old
  echo "Renamed existing Vagrantfile to Vagrantfile_old"
fi

# Generate a new Vagrantfile with the specified settings
cat > Vagrantfile << EOF
